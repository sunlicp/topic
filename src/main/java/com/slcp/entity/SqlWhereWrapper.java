...
public class SqlWhereWrapper {
    ...
    public static <T> IPage<T> getIPage(Search pageQuery) {
        ...
        page.orders().addAll(OrderItem.ascs(filter(StringUtil.humpToUnderline(pageQuery.getAscs()))));
        page.orders().addAll(OrderItem.descs(filter(StringUtil.humpToUnderline(pageQuery.getDescs()))));
        return page;
    }
